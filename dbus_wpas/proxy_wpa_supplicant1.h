...
#ifndef DBUS_GLIB_CLIENT_WRAPPERS_fi_w1_wpa_supplicant1
#define DBUS_GLIB_CLIENT_WRAPPERS_fi_w1_wpa_supplicant1
...
#endif
gboolean
fi_w1_wpa_supplicant1_create_interface (DBusGProxy *proxy, const GHashTable* IN_args, char** OUT_path, GError **error)

{
  return dbus_g_proxy_call (proxy, "CreateInterface", error, dbus_g_type_get_map ("GHashTable", G_TYPE_STRING, G_TYPE_VALUE), IN_args, G_TYPE_INVALID, DBUS_TYPE_G_OBJECT_PATH, OUT_path, G_TYPE_INVALID);
}

typedef void (*fi_w1_wpa_supplicant1_create_interface_reply) (DBusGProxy *proxy, char *OUT_path, GError *error, gpointer userdata);

static void
fi_w1_wpa_supplicant1_create_interface_async_callback (DBusGProxy *proxy, DBusGProxyCall *call, void *user_data)
{
  DBusGAsyncData *data = (DBusGAsyncData*) user_data;
  GError *error = NULL;
  char* OUT_path;
  dbus_g_proxy_end_call (proxy, call, &error, DBUS_TYPE_G_OBJECT_PATH, &OUT_path, G_TYPE_INVALID);
  (*(fi_w1_wpa_supplicant1_create_interface_reply)data->cb) (proxy, OUT_path, error, data->userdata);
  return;
}
...
#endif
DBusGProxyCall*
fi_w1_wpa_supplicant1_create_interface_async (DBusGProxy *proxy, const GHashTable* IN_args, fi_w1_wpa_supplicant1_create_interface_reply callback, gpointer userdata)

{
  ...
  stuff->cb = G_CALLBACK (callback);
  stuff->userdata = userdata;
  return dbus_g_proxy_begin_call (proxy, "CreateInterface", fi_w1_wpa_supplicant1_create_interface_async_callback, stuff, _dbus_glib_async_data_free, dbus_g_type_get_map ("GHashTable", G_TYPE_STRING, G_TYPE_VALUE), IN_args, G_TYPE_INVALID);
}
static
#ifdef G_HAVE_INLINE
inline
#endif
gboolean
fi_w1_wpa_supplicant1_remove_interface (DBusGProxy *proxy, const char* IN_path, GError **error)

{
  return dbus_g_proxy_call (proxy, "RemoveInterface", error, DBUS_TYPE_G_OBJECT_PATH, IN_path, G_TYPE_INVALID, G_TYPE_INVALID);
}

typedef void (*fi_w1_wpa_supplicant1_remove_interface_reply) (DBusGProxy *proxy, GError *error, gpointer userdata);

static void
fi_w1_wpa_supplicant1_remove_interface_async_callback (DBusGProxy *proxy, DBusGProxyCall *call, void *user_data)
{
  DBusGAsyncData *data = (DBusGAsyncData*) user_data;
  GError *error = NULL;
  dbus_g_proxy_end_call (proxy, call, &error, G_TYPE_INVALID);
  (*(fi_w1_wpa_supplicant1_remove_interface_reply)data->cb) (proxy, error, data->userdata);
  return;
}
...
#endif
DBusGProxyCall*
fi_w1_wpa_supplicant1_remove_interface_async (DBusGProxy *proxy, const char* IN_path, fi_w1_wpa_supplicant1_remove_interface_reply callback, gpointer userdata)

{
  ...
  stuff->cb = G_CALLBACK (callback);
  stuff->userdata = userdata;
  return dbus_g_proxy_begin_call (proxy, "RemoveInterface", fi_w1_wpa_supplicant1_remove_interface_async_callback, stuff, _dbus_glib_async_data_free, DBUS_TYPE_G_OBJECT_PATH, IN_path, G_TYPE_INVALID);
}
static
#ifdef G_HAVE_INLINE
inline
#endif
gboolean
fi_w1_wpa_supplicant1_get_interface (DBusGProxy *proxy, const char * IN_ifname, char** OUT_path, GError **error)

{
  return dbus_g_proxy_call (proxy, "GetInterface", error, G_TYPE_STRING, IN_ifname, G_TYPE_INVALID, DBUS_TYPE_G_OBJECT_PATH, OUT_path, G_TYPE_INVALID);
}

typedef void (*fi_w1_wpa_supplicant1_get_interface_reply) (DBusGProxy *proxy, char *OUT_path, GError *error, gpointer userdata);

static void
fi_w1_wpa_supplicant1_get_interface_async_callback (DBusGProxy *proxy, DBusGProxyCall *call, void *user_data)
{
  DBusGAsyncData *data = (DBusGAsyncData*) user_data;
  GError *error = NULL;
  char* OUT_path;
  dbus_g_proxy_end_call (proxy, call, &error, DBUS_TYPE_G_OBJECT_PATH, &OUT_path, G_TYPE_INVALID);
  (*(fi_w1_wpa_supplicant1_get_interface_reply)data->cb) (proxy, OUT_path, error, data->userdata);
  return;
}
...
#endif
DBusGProxyCall*
fi_w1_wpa_supplicant1_get_interface_async (DBusGProxy *proxy, const char * IN_ifname, fi_w1_wpa_supplicant1_get_interface_reply callback, gpointer userdata)

{
  ...
  stuff->cb = G_CALLBACK (callback);
  stuff->userdata = userdata;
  return dbus_g_proxy_begin_call (proxy, "GetInterface", fi_w1_wpa_supplicant1_get_interface_async_callback, stuff, _dbus_glib_async_data_free, G_TYPE_STRING, IN_ifname, G_TYPE_INVALID);
}
#endif /* defined DBUS_GLIB_CLIENT_WRAPPERS_fi_w1_wpa_supplicant1 */
